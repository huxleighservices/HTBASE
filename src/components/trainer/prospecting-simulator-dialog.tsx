...
import { Search, Send, Loader2, Sparkles, ThumbsUp, Lightbulb, Trash2, Bot, User, Save } from 'lucide-react';
            ...
            >
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-3 text-2xl">
                        ...
                        Tr/AI/ner: Prospecting Simulation
                    </DialogTitle>
                    <DialogDescription>
                        Practice your outreach skills. Select a difficulty and start the conversation. You have {USER_MESSAGE_LIMIT} messages to make an impression.
                    </DialogDescription>
                </DialogHeader>
