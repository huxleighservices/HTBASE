...
import { Goal, Send, Loader2, Sparkles, ThumbsUp, Lightbulb, Trash2, Bot, User, Save } from 'lucide-react';
...
export function ClosingSimulatorDialog({ open, onOpenChange, activeSessionId }: { open: boolean, onOpenChange: (open: boolean) => void, activeSessionId: string | null }) {
            ...
            >
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-3 text-2xl">
                        ...
                        Tr/AI/ner: Closing Simulation
                    </DialogTitle>
                    <DialogDescription>
                        Practice the art of closing the deal. Your goal is to get a commitment and define the next steps. You have {USER_MESSAGE_LIMIT} messages.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="flex-grow grid grid-cols-1 md:grid-cols-3 gap-6 overflow-hidden">
                    ...
                    <div className="md:col-span-1 flex flex-col gap-4 p-1 min-h-0">
                        <div className="space-y-2">
                            <Label htmlFor="difficulty-select">Prospect's Readiness</Label>
                            <Select 
                                value={difficulty} 
                            ...
                            >
                                ...
                                <SelectContent>
                                    <SelectItem value="Easy">Ready to Sign 🤝</SelectItem>
                                    <SelectItem value="Medium">Needs a Nudge 🤔</SelectItem>
                                    <SelectItem value="Hard">Has Cold Feet 🥶</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                                ...
                                <ScrollArea className="h-full pr-3 -mr-3">
                                    {!feedback ? (
                                        <div className="flex items-center justify-center h-full text-center text-muted-foreground">
                                            <p>Complete the simulation to receive feedback on your closing skills.</p>
                                        </div>
                                    ) : (
