...
import { Phone, Send, Loader2, Sparkles, ThumbsUp, Lightbulb, Trash2, Bot, User, Save } from 'lucide-react';
...
import { runColdCallSimulation } from '@/ai/flows/cold-call-simulation-flow';
    ...
    const handleSaveResult = async () => {
        ...
        try {
            await addResultToSession(user.uid, sessionToSaveTo, {
                phase: "Prospecting", // This can be changed to "Cold Call" if needed
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            >
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Practice your cold calling skills. Select a difficulty and start the conversation. You have {USER_MESSAGE_LIMIT} messages to make an impression.
                    </DialogDescription>
                </DialogHeader>
