...
export function QualificationSimulatorDialog({ open, onOpenChange, activeSessionId, clientPath, trainingData }: { open: boolean, onOpenChange: (open: boolean) => void, activeSessionId: string | null, clientPath: string | null, trainingData?: string }) {
